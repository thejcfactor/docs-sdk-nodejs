...
Updated C++ core to include fix to allow detection of dysfunctional node.

==== Enhancements

* https://jira.issues.couchbase.com/browse/JSCBC-1280[JSCBC-1280]:
Added ability to use C++ core file logger.
...
* http://jira.issues.couchbase.com/browse/CXXCBC-582[CXXCBC-552]: Cleanup network selection options (https://github.com/couchbase/couchbase-cxx-client/pull/677[#677], https://github.com/couchbase/couchbase-cxx-client/pull/682[#682]). Add cluster labels and system tag to spans.  Add cluster labels, keyspace and outcome to metrics.

===== Fixes

* http://jira.issues.couchbase.com/browse/CXXCBC-311[CXXCBC-311]: Ensure SDK encodes URIs (https://github.com/couchbase/couchbase-cxx-client/pull/674[#674]).
* http://jira.issues.couchbase.com/browse/CXXCBC-599[CXXCBC-599]: Update allowed connection string options (https://github.com/couchbase/couchbase-cxx-client/pull/668[#668]).
* http://jira.issues.couchbase.com/browse/CXXCBC-606[CXXCBC-606]: Fix detection of dysfunctional node (https://github.com/couchbase/couchbase-cxx-client/pull/673[#673]).
* http://jira.issues.couchbase.com/browse/CXXCBC-614[CXXCBC-614]: Fix memory leak in observe_poll (https://github.com/couchbase/couchbase-cxx-client/pull/679[#679]).
