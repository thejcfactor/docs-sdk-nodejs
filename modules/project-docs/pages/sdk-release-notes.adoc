...
Most notably the 4.4.1 release adds support for Alpine ARM environments (See the https://docs.couchbase.com/nodejs-sdk/current/project-docs/compatibility.html#os-compatibility[OS Compatibility docs for details]).
