...
Add KV RangeScan to API Docs

https://jira.issues.couchbase.com/browse/JSCBC-1289[JSCBC-1289]:
Analytics index management link connect/disconnect require a linkName

https://jira.issues.couchbase.com/browse/JSCBC-1290[JSCBC-1290]:
Analytics index management link APIs return CouchbaseError rather than InvalidArgumentError

https://jira.issues.couchbase.com/browse/JSCBC-1291[JSCBC-1291]:
Analytics index management link API cannot create, replace or drop link

https://jira.issues.couchbase.com/browse/JSCBC-1292[JSCBC-1292]:
Analytics index management link APIs return CouchbaseError rather than LinkNotFoundError

https://jira.issues.couchbase.com/browse/JSCBC-1294[JSCBC-1294]:
User management APIs return CouchbaseError rather than InvalidArgumentError

https://jira.issues.couchbase.com/browse/JSCBC-1295[JSCBC-1295]:
User management upserUsert does not properly apply all groups

https://jira.issues.couchbase.com/browse/JSCBC-1296[JSCBC-1296]:
User management getUser passwordChanged field for an external user returns Invalid Date

https://jira.issues.couchbase.com/browse/JSCBC-1298[JSCBC-1298]:
PromiseHelper wrap methods chain `then()` into `catch()`
...
https://jira.issues.couchbase.com/browse/CXXCBC-611[CXXCBC-611], https://jira.issues.couchbase.com/browse/CXXCBC-612[CXXCBC-612]: Follow RFC naming for metric operation names (https://github.com/couchbase/couchbase-cxx-client/pull/695[#695])

https://jira.issues.couchbase.com/browse/CXXCBC-615[CXXCBC-615]: Expose `insert_raw` and `replace_raw` in core transactions attempt context (https://github.com/couchbase/couchbase-cxx-client/pull/686[#686])

https://jira.issues.couchbase.com/browse/CXXCBC-620[CXXCBC-620]: Update core `analytics_link_get_all` to follow RFC (https://github.com/couchbase/couchbase-cxx-client/pull/687[#687])

https://jira.issues.couchbase.com/browse/CXXCBC-622[CXXCBC-622]: Update OpenTelemetry metrics integration to use GA Metrics API (https://github.com/couchbase/couchbase-cxx-client/pull/688[#688])

https://jira.issues.couchbase.com/browse/CXXCBC-624[CXXCBC-624]: Fix user agent ID generation (https://github.com/couchbase/couchbase-cxx-client/pull/692[#692])

https://jira.issues.couchbase.com/browse/CXXCBC-632[CXXCBC-632]: Do not assume Analytics will always send meta fields in response (https://github.com/couchbase/couchbase-cxx-client/pull/699[#699])
