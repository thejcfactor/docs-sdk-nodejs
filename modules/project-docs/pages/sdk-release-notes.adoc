...
Version 4.4.0 is fourth minor release of the fourth generation Node.js SDK, bringing a number of improvements.
// Most notably the 4.4.0 release adds support for ... when using the SDK with Couchbase Server 7.6.2.
